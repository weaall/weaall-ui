...
export const DayLabel = tw.p `font-semibold
${(p) => (p.$day === 0 ? "text-red-500" : p.$day === 6 ? "text-blue-500" : "")}`;
export const DatesWrap = tw.div `flex flex-wrap w-full justify-center my-2`;
export const DateWrap = tw.div `h-10 w-[14%] p-2 text-center flex flex-col justify-center
